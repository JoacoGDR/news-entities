...
exports.InitialMigration1754167051367 = void 0;
class InitialMigration1754167051367 {
    constructor() {
        this.name = 'InitialMigration1754167051367';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`
            ...
            SELECT
                b.story_id,
                (0.6 * (CASE WHEN m.max_articles > 0 THEN b.articles_count / m.max_articles ELSE 0 END)
                 + 0.4 * (CASE WHEN m.max_recency > 0 THEN b.recency / m.max_recency ELSE 0 END)) AS score
...
exports.InitialMigration1754167051367 = InitialMigration1754167051367;
//# sourceMappingURL=1754167051367-InitialMigration.js.map