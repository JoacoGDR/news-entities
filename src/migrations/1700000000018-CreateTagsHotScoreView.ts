...
export class CreateTagsHotScoreView1700000000018 implements MigrationInterface {
    name = 'CreateTagsHotScoreView1700000000018'
  ...
  `);
        ...
        await queryRunner.query(`CREATE INDEX "ix_tags_hot_score_tag_id" ON "tags_hot_score" ("tag_id")`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "ix_tags_hot_score_tag_id"`);
